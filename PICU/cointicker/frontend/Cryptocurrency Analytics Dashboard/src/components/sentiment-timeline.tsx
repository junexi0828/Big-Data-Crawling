...
interface SentimentTimelineProps {
  data24h: Array<{ time: string; positive: number; neutral: number; negative: number }>;
  data7d: Array<{ time: string; positive: number; neutral: number; negative: number }>;
  data30d: Array<{ time: string; positive: number; neutral: number; negative: number }>;
}
